...
namespace Unicepse.ViewModels.RoutineViewModels
{
    public class DayGroupListItemViewModel : ViewModelBase
    {
        ...
        public bool Shoulders
        {
            ...
            set
            {
                _shoulders = value; OnPropertyChanged(nameof(Shoulders));
                if (Shoulders)
                {
        ...
        public bool Back
        {
            ...
            set
            {
                _back = value; OnPropertyChanged(nameof(Back));
                if (Back)
                {
        ...
        public bool Legs
        {
            ...
            set
            {
                _legs = value; OnPropertyChanged(nameof(Legs));
                if (Legs)
                {
        ...
        public bool Biceps
        {
            ...
            set
            {
                _biceps = value; OnPropertyChanged(nameof(Biceps));
                if (Biceps)
                {
        ...
        public bool Triceps
        {
            ...
            set
            {
                _triceps = value; OnPropertyChanged(nameof(Triceps));
                if (Triceps)
                {
        ...
        public bool Abs
        {
            ...
            set
            {
                _abs = value; OnPropertyChanged(nameof(Abs));
                if (Abs)
                {
