...
{
    public class MakePlayerViewModel : ViewModelBase, INotifyDataErrorInfo
    {

        private readonly NavigationService<PlayerListingViewModel>? _navigationService;
        public MakePlayerViewModel(GymStore _gymStore, NavigationService<PlayerListingViewModel> navigationService)
        {
            _navigationService = navigationService;
            SaveCommand = new MakePlayerCommand(_gymStore, this, _navigationService);
            CancelCommand = new NavaigateCommand<PlayerListingViewModel>(_navigationService);
        ...
        private readonly Dictionary<string, List<string>> PropertyNameToErrorsDictionary;
