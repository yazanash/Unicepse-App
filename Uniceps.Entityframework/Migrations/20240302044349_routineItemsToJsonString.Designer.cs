...
namespace Unicepse.Entityframework.Migrations
{
    ...
    [Migration("20240302044349_routineItemsToJsonString")]
    partial class routineItemsToJsonString
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PlatinumGym.Core.Models.TrainingProgram.PlayerRoutine", b =>
                {
                    ...
                    b.OwnsMany("PlatinumGym.Core.Models.TrainingProgram.RoutineItems", "RoutineSchedule", b1 =>
                        {
                            b1.Property<int>("PlayerRoutineId")
                                .HasColumnType("int");
                            ...
                            b1.Property<int>("ExerciseGroupId")
                                .HasColumnType("int");
                            ...
                            b1.Property<string>("Orders")
                                .HasColumnType("nvarchar(max)");

                            b1.HasKey("PlayerRoutineId", "Id");

                            b1.ToTable("PlayerRoutine");

                            b1.ToJson("RoutineSchedule");
